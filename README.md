...
<img width="685" height="898" alt="image" src="https://github.com/user-attachments/assets/710009e1-0394-49e5-b7be-8158dbda2062" />

🚀 Guía de Uso: Registro de un Gasto
Para registrar un nuevo gasto, sigue estos sencillos pasos:

1. Iniciar Sesión (Identificación del Técnico)
...
<img width="667" height="911" alt="image" src="https://github.com/user-attachments/assets/8b5ca47d-facd-4204-be73-58b2c3d7402e" />

Introduce tu número de código de técnico y pulsa "Aceptar".

<img width="903" height="909" alt="image" src="https://github.com/user-attachments/assets/96e6ac7d-31f4-4126-8db3-1b556098d578" />

Una vez autenticado, tu código se cargará automáticamente en el campo "Código del técnico".

<img width="735" height="942" alt="image" src="https://github.com/user-attachments/assets/9d9ffaa4-afa8-4496-9d49-0474d9c3d637" />
...
<img width="525" height="910" alt="image" src="https://github.com/user-attachments/assets/b36ec1fb-0b79-401a-8407-472f5694f539" />

3. Envío de Datos
Una vez completado, pulsa el botón "Enviar".

<img width="508" height="893" alt="image" src="https://github.com/user-attachments/assets/e6051837-9c05-4469-aead-5d2b7f674d00" />

Aparecerá una alerta de confirmación para verificar el envío.

<img width="676" height="927" alt="image" src="https://github.com/user-attachments/assets/a86a8fbb-e310-4ef8-b0d0-6f789de54453" />

Al confirmar, recibirás un mensaje indicando que los datos se han ingresado correctamente en el sistema.

<img width="629" height="916" alt="image" src="https://github.com/user-attachments/assets/cbef816a-460d-44d0-9d02-31ec11cdcc04" />
